...
/** 
 * Classe JogoService, responsavel por inserções HTML, e chamadas do JogoDAO.
 * 
 * @javadoc
 */ 
public class JogoService {
	...
	*/
	...
	/**
	* Chamada do método UPDATE no Jogo.
	* 
	*/
	...
	/**
	* Método responsavel pela atualização do Jogo.
	* 
	*/
